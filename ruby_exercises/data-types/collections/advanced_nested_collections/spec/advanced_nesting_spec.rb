...
RSpec.describe 'Advanced Nested Collections' do
  ...
  it 'test 7' do
    ...
    stores.each do |restaurant, employees|
      employee_names += employees[:employees]
    end
  ...
  it 'test 9' do
    ...
    stores[:olive_garden][:dishes].each do |dish_details|
      full_menu_price += dish_details[:price]
    end
